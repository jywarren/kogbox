...
function get_snippet_info($my_user_id,$my_method_name,$version = false) {
	...
	if ($published == "public" && $license != "") :
		return $snippet_info;
	else :
		return "Snippet '".$my_method_name."' by user #".$my_user_id." not available. It may have been renamed or may not exist.";
	endif;
}
